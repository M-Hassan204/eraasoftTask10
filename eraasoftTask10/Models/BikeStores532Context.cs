...
namespace eraasoftTask10.Models;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=.;Database=BikeStores532;Trusted_Connection=True;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Brand>(entity =>
        {
            entity.HasKey(e => e.BrandId).HasName("PK__brands__5E5A8E2757C6FEEE");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__categori__D54EE9B4D15EF290");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB850FD94E13");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__orders__465962296591BE15");
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ItemId }).HasName("PK__order_it__837942D4CC398971");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__products__47027DF57C349101");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staffs__1963DD9CC410BFC4");

            entity.ToTable("staffs", "sales");

            entity.HasIndex(e => e.Email, "UQ__staffs__AB6E6164D0495DA4").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.StoreId, e.ProductId }).HasName("PK__stocks__E68284D3C8C3D1E0");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__stores__A2F2A30CED1971E3");
